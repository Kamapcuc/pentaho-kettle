...
public class Const {
  ...
  public static String JNDI_DIRECTORY = NVL(
      System.getProperty( "KETTLE_JNDI_ROOT" ), System.getProperty( "org.osjava.sj.root" ) ); //$NON-NLS-1$ //$NON-NLS-2$
  ...
  /** The internal clustered run ID, unique across a clustered execution, 
   *  important while doing parallel clustered runs */
   ...
   * overflow while rounding TODO: make the rounding itself optional in the Props for performance reasons.
   * 
   * @param f
   *          The value to round
   * @param places
